...
//
// Props:
//   onSignInWithGoogle — starts the OAuth redirect flow
//   onDismiss         — hides the banner and marks it as seen in localStorage
// =============================================================================
      ...
      <div className="flex min-w-0 flex-col gap-1">
        ...
        <div className="mt-2 flex flex-wrap gap-2">
          <button
            ...
            className={cn(
              "flex items-center gap-2 rounded-md border border-tingle-aqua/30",
          ...
          >
            {/* Google "G" mark — inline SVG keeps the bundle zero-dep */}
